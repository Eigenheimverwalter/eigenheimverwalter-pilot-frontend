...
export async function renderPremiumStep(host,flow,{request,resume}){
  ...
  host.innerHTML=`<section class="premium-hero"><div><span class="premium-eyebrow">IHRE PREMIUM-PARTNERSCHAFT</span>
    <h2>${broker?'Aus Immobilienwissen werden fundierte Verkaufschancen.':'Aus einzelnen Aufträgen wird dauerhafte Betreuung.'}</h2><p>${broker?'Begleiten Sie Eigentümer von der angefragten Verkehrswertermittlung über eine strukturierte Verkaufsakte bis zum Mandat und Immobilienverkauf. Die scheckheftgepflegte Immobilie schafft eine nachvollziehbare Grundlage für Ihre Beratung.':'Gemeinsam machen wir die scheckheftgepflegte Immobilie zum Standard: Leistungen nachvollziehbar dokumentieren, Eigentümer verlässlich begleiten und Immobilienwerte langfristig erhalten.'}</p>
    ...
    ${broker?'<div class="premium-broker-benefits"><h3>Ihr Makler-Premium</h3><ul><li>Regionale Verkaufschancen von eigenheimverwalter</li><li>Verkaufsakten bei angefragter Verkehrswertermittlung</li><li>Mandat, Vermarktung und Abschluss strukturiert begleiten</li></ul><p>Keine Gewerkauswahl und keine Handwerker-Equipmentpflege.</p></div>':`<figure><img src="${image}" width="1536" height="1024" alt="Handwerker und Eigentümerin besprechen die Betreuung ihres Hauses"><figcaption>Illustration der Zusammenarbeit · KI-generiert</figcaption></figure>`}</section>
    ...
    </section><section class="card premium-summary" aria-label="Preisübersicht"><span class="premium-eyebrow">${broker?'MAKLERPARTNER':'HANDWERKSPARTNER'} PREMIUM</span><h2>Ihre Jahresmitgliedschaft</h2><dl data-price></dl>
